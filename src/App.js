...
function Home() {
  ...
  useEffect(() => {
    ...
    emailjs.init('b1uAqcSNYqu6gG1rd');
    ...
    <div className="min-h-screen bg-white text-gray-900 antialiased">
      ...
      <nav className="flex items-center justify-between p-6 fixed w-full bg-white z-10">
        ...
        <ul className="hidden md:flex space-x-8 text-lg">
          <li><HashLink smooth to="/#projects" className="hover:text-gray-600">Projects</HashLink></li>
          <li><HashLink smooth to="/#about" className="hover:text-gray-600">About</HashLink></li>
          <li><HashLink smooth to="/#contact" className="hover:text-gray-600">Contact</HashLink></li>
        </ul>
        <button className="md:hidden focus:outline-none" onClick={() => {/* mobile menu toggle if needed */}}>
      ...
      <section
        ...
        onClick={() => navigate(`/projects/${projects[current].id}`)}
      >
        <AnimatePresence>
      ...
      <section id="hero" className="flex flex-col items-center justify-center text-center py-32">
        ...
        <motion.p className="mt-6 text-lg max-w-xl"
      ...
      <section id="about" className="py-16">
        <div className="container mx-auto px-6 md:px-12">
          ...
          <p className="max-w-3xl mx-auto text-center leading-relaxed">
            A Tata Imagination Challenge National Semi-finalist with credible certifications like Microsoft Certified: Azure AI Fundamentals and Computer Vision with Embedded Machine Learning. My background in Computer Applications, Data Science, AI Algorithm development, and Spatial Analytics uniquely positions me to build intelligent, data-driven solutions.
          </p>
        </div>
      </section>
      ...
      <section id="contact" className="py-16 bg-gray-50">
        <div className="container mx-auto px-6 md:px-12">
          ...
          <form ref={formRef} onSubmit={sendEmail} className="max-w-xl mx-auto grid grid-cols-1 gap-6">
            <input type="text" name="user_name" placeholder="Your Name" required className="p-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400" />
            <input type="email" name="user_email" placeholder="Your Email" required className="p-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400" />
            <textarea name="message" placeholder="Message" rows="4" required className="p-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400" />
