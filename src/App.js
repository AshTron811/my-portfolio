...
const projects = [
  { title: "Real-time Soil Moisture Prediction", img: "/imgs/proj1.jpg" },
  { title: "Customer Segmentation and Prediction", img: "/imgs/proj2.jpg" },
  { title: "Time Series Forecasting and GenAI Trend Analyser", img: "/imgs/proj3.jpg" },
];
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 antialiased">
      ...
      {/* Fullscreen Projects Slider */}
      <section id="slider" className="relative w-full h-screen overflow-hidden">
        <AnimatePresence>
      ...
      <section id="hero" className="flex flex-col items-center justify-center text-center py-32">
        ...
        >
          I'm an AI enthusiast & developer showcasing a unique blend of expertise in domains like Software Development, Artificial and Geospatial Intelligence.
        </motion.p>
      </section>
